...
.left{ position: fixed; left: 0; top: 0px; width: 120px; height: calc(100% - 0px); background-color: #282828;}
...
.right{ margin-left: 120px; padding: 0px 20px 30px 15px; background-color: #1E1D1B;}
</style>
